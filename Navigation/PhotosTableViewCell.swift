...
class PhotosTableViewCell: UITableViewCell {
    ...
    private lazy var firstImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "foto_zvezd_01")
        return imageView
    }()
    ...
    private lazy var secondImageView: UIImageView = {
        ...
        imageView.clipsToBounds = true
        imageView.layer.cornerRadius = 6
        imageView.image = UIImage(named: "foto_zvezd_02")
        return imageView
    }()
    ...
    private lazy var thirdImageView: UIImageView = {
        ...
        imageView.clipsToBounds = true
        imageView.layer.cornerRadius = 6
        imageView.image = UIImage(named: "foto_zvezd_03")
        return imageView
    }()
    ...
    private lazy var fourthImageView: UIImageView = {
        ...
        imageView.clipsToBounds = true
        imageView.layer.cornerRadius = 6
        imageView.image = UIImage(named: "foto_zvezd_04")
        return imageView
    }()
